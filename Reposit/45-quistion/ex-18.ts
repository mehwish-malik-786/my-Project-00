...
// .reverse orignal arry by .Sort
 let printOfArray = favPlace.sort()
// console.log(printOfArray);

let reverseOrignalArray = printOfArray.reverse();
console.log(reverseOrignalArray);
